...
(function() {
	...
	function FileDragHover(e) {
		e.stopPropagation();
		e.preventDefault();
		$id("ebillfileselect1").className = (e.type == "dragover" ? "hover" : ".xls");
	...
	function ParseFile(file) {
		...
		var x = document.getElementById('ebillfileselect1').value;
		Output(
	...
	// initialize
	function Init() {
	var fileselect = $id("ebillfileselect1"),
			filedrag = $id("ebillfiledrag1"),
