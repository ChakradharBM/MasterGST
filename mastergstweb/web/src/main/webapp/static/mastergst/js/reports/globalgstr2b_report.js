...
function loadGlobalReportsInvTable(id, clientidsArray, varRetType, varRetTypeCode, month, year, userType, fullname,booksorReturns, type){
	...
	invTableReports = $('#gloablReports_dataTable'+varRetTypeCode).DataTable({
...
function reloadInvTable(retTypeCode, typeArr, userArr, vendorArr, branchArr, verticalArr){
...
function applyAdminInvFilters(retType) {
	...
	reloadInvTable(retTypeCode, typeArr, userArr, vendorArr, branchArr, verticalArr);
	var type = $('#fillingoption span').html();
	if(type == 'Yearly'){
