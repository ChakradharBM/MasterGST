...
(function() {
	...
	function FileDragHover(e) {
		e.stopPropagation();
		e.preventDefault();
		$id("gstnoFile").className = (e.type == "dragover" ? "hover" : ".xls");
...
//alert(files);
		...
		if(e.dataTransfer.files){
			...
			$("#gstnoFile").prop("files", e.dataTransfer.files);
			$('#idSheetgstno').show();
	...
	function ParseFile(file) {
		...
		var x = document.getElementById('gstnoFile').value;
		Output(
	...
	function Init() {
		...
		var fileselect = $id("gstnoFile"),
			filedrag = $id("filedraggstno"),
