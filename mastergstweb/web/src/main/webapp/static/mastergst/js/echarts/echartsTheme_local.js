...
function download() {
    if (themeName) {
        window.open('/mastergst/static/mastergst/js/echarts/theme/' + themeName + '.js');
    }
}
...
if (developMode) {
    ...
    (function () {
        ...
        script.src = '/mastergst/static/mastergst/js/echarts/esl/esl.js';
        ...
        function loadedListener() {
            ...
            require.config({
                packages: [
                    {
                        name: 'echarts',
                        location: '/mastergst/static/mastergst/js/echarts',
                        main: 'echarts'
                    },
                    {
                        name: 'zrender',
    ...
    require.config({
        paths: {
            echarts: '/mastergst/static/mastergst/js/echarts'
        }
    });
    launchExample();
}
