...
<div id="clients_group" class="clients_group pull-left p-2">
	<div class="form-group mb-0">
		<label for="multeselectclient">Customers :</label>
		<select id="multeselectclientc_${ackTabName}" class="multeselectclientc_${ackTabName} multiselect-ui form-control multeselectclientc" multiple="multiple">
			<c:forEach items="${customers}" var="customer">
				<option value="${customer}"><c:out value="${customer}"/></option>
			</c:forEach>
		</select>
		<span id="clientErrMsgc_${ackTabName}" style="display:none;color:red;font-size:14px">Please select at least one client/business name</span>
	</div>
</div>
...
<c:if test="${ackTabName eq 'reportsTab'}">
	<span class="text-center" style="color:red"> Reports Under Construction</span>
</c:if>
