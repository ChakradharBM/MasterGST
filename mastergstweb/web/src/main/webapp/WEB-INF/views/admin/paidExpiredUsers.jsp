		...
		<div class="container" style="padding-top: 30px;">
			<div class="row">
				...
				<div class="customtable tabtable col-sm-12">
					<table id="dbTable_PAID_EXPIRED_USERS" class="display dataTable meterialform col-sm-12 p-0"  cellspacing="0" width="100%">
						<thead>
							<tr>
								<th>Name</th>
								<th>Email</th>
...
var paidExpiryTable;
	$(document).ready(function() {
		...
		loadExpiryUsersDetails('<c:out value="${id}"/>', 'PAID_EXPIRED_USERS');
	});
	...
	function formatReferenceIdAndName(dat, type, row){
		...
		//return '<div class="checkbox"><label><input type="checkbox" name="check[]" id='+refId+' onClick="sendEmail(\''+refId+'\'+\''+name+'\',this)" class="datatablebodycheckbox checkbox"/><i class="helper"></i></label></div>';
		//return '<div class="checkbox"><label><input type="checkbox" name="check[]" id='+refId+' onClick="sendEmail(\''+refId+'\',this)" class="datatablebodycheckbox checkbox"/><i class="helper"></i></label></div>';
	} 
