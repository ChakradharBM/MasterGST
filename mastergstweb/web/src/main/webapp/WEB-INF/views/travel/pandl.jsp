...
<body class="body-cls">
	...
	<div class="db-ca-wrap">
		<div class="container">
			...
			<h2>
				<span class="reports-monthly" style="font-size:20px">P & L Report</span>
			</h2>
			<div class=""></div>
			</br>
			<div class="">
				<div class="dropdown chooseteam mr-0" style="z-index:2;">
					...
					<span style="display:none" class="yearly-sp"> 
						...
						<select class="ret-type1" id="financialYear1" style="width: 108px !important;border-radius: 2px;border: 1px solid black;margin-right: 6px;background-color: white;">
			...
			<div class="tab-pane" id="gtab1" role="tabpanel">
			            ...
			            <div class="noramltable-row-desc">
			                <select id="multiselect${varRetTypeCode}4" class="multiselect-ui form-control" multiple="multiple">
			               	...
			               	<select id="multiselect${varRetTypeCode}2" class="multiselect-ui form-control" multiple="multiple">
			               		<option value="127702">127702</option>
			                    <option value="126632">126632</option>
			                    <option value="120092">120092</option>
			               	</select>
				...
				<div class="customtable db-ca-view salestable reports_dataTable">
					<table id='reports_dataTable' class="row-border dataTable meterialform" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th class="text-center">Route</th><th class="text-center">Service ID / Route ID</th><th class="text-center">Service Type</th><th class="text-center">Income</th><th class="text-center">Expenditure</th><th class="text-center">Profit</th>
							</tr>
						</thead>
						<tbody id='invBodyVariableExp'>
							<tr>
								<td class="text-center">Kadapa-Hyd </td>
								<td class="text-center">209122</td>
							...
							<tr>
								...
								<td class="text-center">209196</td>
								<td class="text-center">NON-AC</td>
								<td class="text-right">5,200</td>
								<td class="text-right">2,000</td>
								<td class="text-right">3,800</td>
							</tr>
							...
							<tr>
								...
								<td class="text-center">209170</td>
								<td class="text-center">NON-AC</td>
								<td class="text-right">5,200</td>
								<td class="text-right">2,000</td>
								<td class="text-right">3,800</td>
							...
							<tr>
								<td class="text-center">vizag-Hyd</td>
								<td class="text-center">209170</td>
								<td class="text-center">NON-AC</td>
								<td class="text-right">5,200</td>
								<td class="text-right">2,000</td>
							...
							<tr>
								<td class="text-center">Kadapa-Hyd </td>
								<td class="text-center">209190</td>
								<td class="text-center">AC</td>
								<td class="text-right">5,200</td>
								<td class="text-right">2,000</td>
								<td class="text-right">3,800</td>
