...
<head>
    ...
    <title>MasterGST | variable expence report</title>
...
<body class="body-cls">
	     	...
	     	<div class="row">
	        	<div class="col-md-12 col-sm-12">
	            	<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">variable expence report</li>
	                </ol>
	...
	<div class="db-ca-wrap">
		<div class="container">
			...
			<h2>
				<span class="reports-monthly" style="font-size:20px">hyd-Chittor AC Sleeper-Early with Service No AP04Z0122 Report</span>
			</h2>
			<div class=""></div>
			</br>
			<div class="">
				<div class="dropdown chooseteam mr-0" style="z-index:2;">
					<span class="dropdown-toggle yearly" data-toggle="dropdown" id="fillingoption" style="margin-right: 10px; display: inline-flex;"><label>Report Type:</label>
							...
							<select class="ret-type" id="selcted-val" onchange="changedval(this)" style="width: 108px !important;border-radius: 2px;border: 1px solid black;margin-right: 6px;">
			...
			<div class="tab-pane" id="gtab1" role="tabpanel">
			        ...
			        <div class="noramltable-row">
			            ...
			            <div class="noramltable-row-desc">
			                <select id="multiselect${varRetTypeCode}1" class="multiselect-ui form-control" multiple="multiple">
			                    <option value="Pondicherry-Hyd">Pondicherry -Hyd Sleeper AC</option>
			                    <option value="Hyd-Tirupati">Hyd-Tirupati, Non AC Sleeper</option>
			                    <option value=">Hyd-Kadapa">Hyd-Kadapa, AC Sleeper</option>
			               	...
			               	<select id="multiselect${varRetTypeCode}6" class="multiselect-ui form-control" multiple="multiple">
			               		<option value="AP04Z0122">AP04Z0122</option>
			                    <option value="AP04Z0114">AP04Z0114</option>
			                    <option value="AP04Z0125">AP04Z0125</option>
			               	</select>
			            </div>
			        </div>
			    </div>
				<div class="customtable db-ca-view salestable reports_dataTable">
					<table id='reports_dataTable' class="row-border dataTable meterialform" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th>Date</th><th class="text-center">Route</th><th class="text-center">Bus Number</th><th class="text-center">Total</th><th class="text-center">Diesel</th><th class="text-center">Maintanence</th><th class="text-center">Advance</th><th class="text-center">Tollgate</th>
							</tr>
						</thead>
						<tbody id='invBodyVariableExp'>
							<tr>
								<td>01-02-2021</td>
								<td class="text-center">hyd-Chittor</td>
								<td class="text-center">AP04Z0122</td>
								<td class="text-right">26,500</td>
							...
							<tr>
								<td>05-01-2021</td>
								<td class="text-center">Hyd-Chittor Non AC Sleeper</td>
								<td class="text-center">AP04Z0125</td>
								<td class="text-right">30,500</td>
								<td class="text-right">5,200</td>
								<td class="text-right">2,000</td>
								<td class="text-right"class="text-right">10,000</td>
								<td class="text-right">320</td>
							</tr>
							<tr>
								<td>06-02-2021</td>
								<td class="text-center">Chittor-Hyd Non AC Sleeper/Seater</td>
								<td class="text-center">AP04Z0122</td>
							...
							<tr>
								<td>03-01-2021</td>
								<td class="text-center">Kadapa-Hyd, AC Sleeper</td>
								<td class="text-center">AP04Z0125</td>
							...
							<tr>
								<td>09-02-2021</td>
								<td class="text-center">Hyd-Vempalli, AC Sleeper/Seater</td>
								<td class="text-center">AP04Z0122</td>
							...
							<tr>
								<td>19-01-2021</td>
								<td class="text-center">A.S Peta-Hyd ,Non AC Sleeper/Seater</td>
								<td class="text-center">AP04Z0125</td>
							...
							<tr>
								<td>17-02-2021</td>
								<td class="text-center">Tirupati-Hyd, Non AC Sleeper</td>
								<td class="text-center">AP04Z0122</td>
							...
							<tr>
								<td>22-01-2021</td>
								<td class="text-center">Pondicherry -Hyd Sleeper AC</td>
								<td class="text-center">AP04Z0125</td>
							...
							<tr>
								<td>21-02-2021</td>
								<td class="text-center">Hyd-Kadapa, AC Sleeper</td>
								<td class="text-center">AP04Z0122</td>
								<td class="text-right">26,500</td>
								<td class="text-right">5,200</td>
								<td class="text-right">2,000</td>
							...
							<tr>
								<td>15-01-2021</td>
								<td class="text-center">Vempalli-hyd,AC Sleeper/Seater</td>
								<td class="text-center">AP04Z0125</td>
								<td class="text-right">29,500</td>
								<td class="text-right">5,200</td>
								<td class="text-right">2,000</td>
							...
							<tr>
								<td>11-02-2021</td>
								<td class="text-center">Badvel-Hyd</td>
								<td class="text-center">AP04Z0122</td>
								<td class="text-right">26,500</td>
								<td class="text-right">5,200</td>
								<td class="text-right">2,000</td>
							...
							<tr>
								<td>25-01-2021</td>
								<td class="text-center">Vijaywada-kadapa,AC Sleeper</td>
								<td class="text-center">AP04Z0125</td>
								<td class="text-right">21,500</td>
								<td class="text-right">5,200</td>
								<td class="text-right">2,000</td>
								<td class="text-right"class="text-right">12,000</td>
								<td class="text-right">620</td>
							</tr>
						</tbody>
					</table>
