...
<head>
    ...
    <title>MasterGST | GST Payment report</title>
...
<body class="body-cls">
	     	...
	     	<div class="row">
	        	<div class="col-md-12 col-sm-12">
	            	<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">GST Payment report</li>
	                </ol>
	...
	<div class="db-ca-wrap">
		<div class="container">
			...
			<h2>
				<span class="reports-monthly" style="font-size:20px">GST Payment report</span>
			</h2>
			<div class=""></div>
			</br>
			<div class="">
			...
			<div class="tab-pane" id="gtab1" role="tabpanel">
			        ...
			        <div class="noramltable-row">
			            ...
			            <div class="noramltable-row-desc">
			               	<select id="multiselect${varRetTypeCode}2" class="multiselect-ui form-control" multiple="multiple">
			               		<option value="117702">117702</option>
				...
				<div class="customtable db-ca-view salestable reports_dataTable">
					<table id='reports_dataTable' class="row-border dataTable meterialform" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th class="text-center">Service Number</th><th class="text-center">Total Ticket Value</th><th class="text-center">GST(5%)</th><th class="text-center">TCS(1%)</th><th class="text-center">Net GST Payable(D-E)</th>
							</tr>
						</thead>
						<tbody id='invBodyVariableExp'>
							<tr>
								<td class="text-center">117120</td>
							...
							<tr>
								<td class="text-center">1271340</td>
								<td class="text-center">2,000</td>
								<td class="text-center">100</td>
								<td class="text-center">10</td>
								<td class="text-center">2,110</td>
							...
							<tr>
								<td class="text-center">128850</td>
								<td class="text-center">2,000</td>
								<td class="text-center">100</td>
								<td class="text-center">10</td>
								<td class="text-center">2,110</td>
							...
							<tr>
								<td class="text-center">127134</td>
								<td class="text-center">2,000</td>
								<td class="text-center">100</td>
								<td class="text-center">10</td>
								<td class="text-center">2,110</td>
							...
							<tr>
								<td class="text-center">121250</td>
								<td class="text-center">2,000</td>
								<td class="text-center">100</td>
								<td class="text-center">10</td>
								<td class="text-center">2,110</td>
							...
							<tr>
								<td class="text-center">127120</td>
								<td class="text-center">2,000</td>
								<td class="text-center">100</td>
								<td class="text-center">10</td>
								<td class="text-center">2,110</td>
