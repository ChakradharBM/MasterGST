      ...
      <div class="container">
        <div class="row">
          ...
          <div class="formboxwrap">
           <h3>Filing GST and paying your taxes is Simpler Now</h3>
                ...
                <form class="meterialform">
                    ...
                    <!-- serverside error end --> 
                        <div class="col-xs-12 p-4">
                           <p class="alert sucess-txt text-center">You have signed up successfully .</p>
                           <p class="alert sucess-txt text-center">Thank you for choosing MasterGST, please check your mail for more details.</p>
                           
                        </div>
                     </div>
                     <div class="bluebg">
                        <p><a href="login" class="btn btn-lg btn-blue">Continue to Login</a></p>
                     </div>
                  </form>
              </div>
            </div>
