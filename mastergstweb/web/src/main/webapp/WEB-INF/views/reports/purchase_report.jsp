...
<head>
    ...
    <title>MasterGST | Purchase Report</title>
...
<body class="body-cls">
	...
	<div class="db-ca-wrap">
		<div class="container">
			...
			<h2>
				<span class="reports-monthly">Monthly Purchase Report of <c:choose><c:when test='${fn:length(client.businessname) > 25}'>${fn:substring(client.businessname, 0, 25)}..</c:when><c:otherwise>${client.businessname}</c:otherwise></c:choose></span>
				<span class="reports-yearly" style="display: none;">Yearly Purchase Report of <c:choose><c:when test='${fn:length(client.businessname) > 25}'>${fn:substring(client.businessname, 0, 25)}..</c:when><c:otherwise>${client.businessname}</c:otherwise></c:choose></span>
				<span class="reports-custom" style="display: none;">Custom Purchase Report of <c:choose><c:when test='${fn:length(client.businessname) > 25}'>${fn:substring(client.businessname, 0, 25)}..</c:when><c:otherwise>${client.businessname}</c:otherwise></c:choose></span>
			</h2>
			<p>
				<span class="reports-monthly">Monthly Purchase Report gives you a summary of your monthly Purchase.</span>
				<span class="reports-yearly" style="display: none;">Monthly Purchase Report gives you a summary of your monthly Purchase.</span>
				<span class="reports-custom" style="display: none;">Monthly Purchase Report gives you a summary of your monthly Purchase.</span>
			</p>
			<div class="helpguide reporthelpguide dropdown helpicon" data-toggle="modal" data-target="#reporthelpGuideModal" style="display:flex;float:left;margin-top:0px;">
				Help To Read This Report<div class="dropdown-content reportSales"> <span class="arrow-up"></span><span class="pl-2"> All the Purchase Invoices from your Purchase Register/Books Monthly, Yearly and Custom Wise</span></div>
			</div>
			...
			<div class="tab-pane" id="gtab1" role="tabpanel">
			    <div class="normaltable meterialform" id="updatefilter_summary_reports" style="display:none;">
			        <div class="filter">
			            <div class="noramltable-row">
			                ...
			                <div class="noramltable-row-desc">
			                    <div class="sfilter"><span id="divFilters${varRetTypeCode}"></span>
			                        <span class="btn-remove-tag" onClick="clearInvFiltersReports('${varRetTypeCode}','')">Clear All<span data-role="remove"></span></span>
			                    </div>
			                </div>
			            </div>
			        </div>
			        ...
			        <div class="noramltable-row">
			            ...
			            <div class="noramltable-row-desc">
			                ...
			                <div class="normaltable-col hdr filsummary">Total TDS<div class="normaltable-col-txt" id="idTCSTDS${varRetTypeCode}"></div></div>
			                <div class="normaltable-col hdr">Total ITC<div class="normaltable-col-txt" id="idITCVal${varRetTypeCode}"></div></div>
			            </div>
			        </div>
			    </div>
				<div class="customtable db-ca-view reportTable reportTable4 fixed-col-div" id="${varRetTypeCode}SummaryTable" style="display:none">
				    ...
				    <div class="col-sm-3"><a href="${contextPath}/dwnldReportsFinancialSummaryxls/${id}/${client.id}/GSTR2?reporttype=invoice_report&year=${year}&fromdate=null&todate=null" id="dwnldxls" class="btn btn-blue mb-3 pull-right excel_btn" style="padding: 6px 15px 5px;font-weight: bold;color: #435a93;" data-toggle="tooltip" data-placement="top" title="Download Financial Summary To Excel">Download To Excel<i class="fa fa-download ml-1" aria-hidden="true"></i></a></div>
				    </div>
				    ...
				    <table id="reportTable4" class="display row-border dataTable fixed-col meterialform" cellspacing="0" width="100%">
				        ...
				        <tbody id="yeartotoalreport">
					        <tr><td align="center"><h6>Transactions</h6> </td><td class="text-right" id="totalinvoices4">0</td><td class="text-right" id="totalinvoices5">0</td><td class="text-right" id="totalinvoices6">0</td><td class="text-right" id="totalinvoices7">0</td><td class="text-right" id="totalinvoices8">0</td><td class="text-right" id="totalinvoices9">0</td><td class="text-right" id="totalinvoices10">0</td><td class="text-right" id="totalinvoices11">0</td><td class="text-right" id="totalinvoices12">0</td><td class="text-right" id="totalinvoices1">0</td><td class="text-right" id="totalinvoices2">0</td><td class="text-right" id="totalinvoices3">0</td><td class="text-right ind_formatss" id="ytotal_Transactions">0</td></tr>
						  	...
						  	<tr><td align="center"><h6>ITC Amount</h6> </td><td class="text-right ind_formatss" id="itcAmt4">0.0</td><td class="text-right ind_formatss" id="itcAmt5">0.0</td><td class="text-right ind_formatss" id="itcAmt6">0.0</td><td class="text-right ind_formatss" id="itcAmt7">0.0</td><td class="text-right ind_formatss" id="itcAmt8">0.0</td><td class="text-right ind_formatss" id="itcAmt9">0.0</td><td class="text-right ind_formatss" id="itcAmt10">0.0</td><td class="text-right ind_formatss" id="itcAmt11">0.0</td><td class="text-right ind_formatss" id="itcAmt12">0.0</td><td class="text-right ind_formatss" id="itcAmt1">0.0</td><td class="text-right ind_formatss" id="itcAmt2">0.0</td><td class="text-right ind_formatss" id="itcAmt3">0.0</td><td class="text-right ind_formatss" id="ytotal_ITCvalue">0.0</td></tr>
						  	<tr><td align="center"><h6>TCS Receivable</h6> </td><td class="text-right ind_formatss" id="tcsAmt4">0.0</td><td class="text-right ind_formatss" id="tcsAmt5">0.0</td><td class="text-right ind_formatss" id="tcsAmt6">0.0</td><td class="text-right ind_formatss" id="tcsAmt7">0.0</td><td class="text-right ind_formatss" id="tcsAmt8">0.0</td><td class="text-right ind_formatss" id="tcsAmt9">0.0</td><td class="text-right ind_formatss" id="tcsAmt10">0.0</td><td class="text-right ind_formatss" id="tcsAmt11">0.0</td><td class="text-right ind_formatss" id="tcsAmt12">0.0</td><td class="text-right ind_formatss" id="tcsAmt1">0.0</td><td class="text-right ind_formatss" id="tcsAmt2">0.0</td><td class="text-right ind_formatss" id="tcsAmt3">0.0</td><td class="text-right ind_formatss" id="ytotal_Tcsvalue">0.0</td></tr>
						  	<tr><td align="center"><h6>TDS Payable</h6> </td><td class="text-right ind_formatss" id="tdsAmt4">0.0</td><td class="text-right ind_formatss" id="tdsAmt5">0.0</td><td class="text-right ind_formatss" id="tdsAmt6">0.0</td><td class="text-right ind_formatss" id="tdsAmt7">0.0</td><td class="text-right ind_formatss" id="tdsAmt8">0.0</td><td class="text-right ind_formatss" id="tdsAmt9">0.0</td><td class="text-right ind_formatss" id="tdsAmt10">0.0</td><td class="text-right ind_formatss" id="tdsAmt11">0.0</td><td class="text-right ind_formatss" id="tdsAmt12">0.0</td><td class="text-right ind_formatss" id="tdsAmt1">0.0</td><td class="text-right ind_formatss" id="tdsAmt2">0.0</td><td class="text-right ind_formatss" id="tdsAmt3">0.0</td><td class="text-right ind_formatss" id="ytotal_Tdsvalue">0.0</td></tr>
				        </tbody>
				    </table>
				</div>
				<div class="customtable db-ca-view salestable reportsdbTable${varRetTypeCode}">
					<table id='reports_dataTable${varRetTypeCode}' class="row-border dataTable meterialform" cellspacing="0" width="100%">
						<thead>
							<tr>
				    ...
				    <div class="modal-dialog modal-md modal-right" role="document">
				        <div class="modal-content">
				            <div class="modal-body">
				                ...
				                <div class="p-2 steptext-wrap"><span class="pl-2">All the Purchase Invoices from your Purchase Register/Books Monthly, Yearly and Custom Wise</span></div>
				            </div>
	...
	<script type="text/javascript">
		$(function(){
			...
			invsDownloads('${id}', '${client.id}', '${varRetType}','${varRetTypeCode}', '${month}', '${year}', '${usertype}', '${fullname}', 'abcd','Monthly');
		});
		function generateData() {
			var abc = $('#fillingoption span').html();
			var booksOrReturns = '';
			var type='';
			clearInvFiltersReportss('${varRetTypeCode}');
			if(abc == 'Monthly'){
				$('#${varRetTypeCode}SummaryTable').css("display", "none");
				...
				invsDownloads('${id}', '${client.id}', '${varRetType}','${varRetTypeCode}', mn, yr, '${usertype}', '${fullname}', 'abcd', 'Monthly');
				initiateCallBacksForMultiSelectReports('${varRetType}','${varRetTypeCode}');
				initializeRemoveAppliedFiltersReports('${varRetType}','${varRetTypeCode}');
			}else if (abc == 'Yearly') {
				...
				loadReportsSummary('${id}', '${varRetType}','${client.id}', 0, year[1], type);
				initiateCallBacksForMultiSelectReports('${varRetType}','${varRetTypeCode}');
				initializeRemoveAppliedFiltersReports('${varRetType}','${varRetTypeCode}');
