...
<title>MasterGST | HSN Sales Report</title>
...
.dt-buttons{left: 59%;}
.dropdown:hover .dropdown-content.reporthsnSales{display: block;}.arrow-up {width: 0; height: 0; border-left: 9px solid transparent;border-right: 9px solid transparent;border-bottom: 12px solid white; position: absolute;top: -8px;}.dropdown {position: relative;display: inline-block;}.dropdown-content.reporthsnSales{display: none;margin-top: 20px;position: absolute;background-color: white;min-width: 590px; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);z-index: 1;color: black;padding: 12px 16px;text-decoration: none;margin-left: -13px; text-transform: capitalize;}.helpbtn.dropdown:hover .dropdown-content {display: block;}
</style>
...
var invoiceArray=new Object();
	...
	if(abc == 'Monthly'){
		...
		$.ajax({
				...
				if(invoiceList instanceof Array) {
					if(invoiceList.length > 0) {
						...
						invoiceList.forEach(function(invoice){
							 if(invoice.invtype == 'B2B' || invoice.invtype == 'B2C' || invoice.invtype == 'Exports' || invoice.invtype == 'Advance Adjusted Detail' ||invoice.invtype == 'Advances' ||  invoice.invtype == 'Nil Supplies' || invoice.invtype == 'Credit/Debit Notes' || invoice.invtype == 'Credit/Debit Note for Unregistered Taxpayers') {
								if(invoice.items){
			...
			$(".reportTable4  div.toolbar").html('<h4>Yearly Summary of '+clientname+'</h4>');
			...
			success : function(invoiceList) {
				...
				if(invoiceList instanceof Array) {
					if(invoiceList.length > 0) {
						...
						var i=1;
						invoiceList.forEach(function(invoice){
							 if(invoice.invtype == 'B2B' || invoice.invtype == 'B2C' || invoice.invtype == 'B2CL' || invoice.invtype == 'Exports' || invoice.invtype == 'Advance Adjusted Detail' ||invoice.invtype == 'Advances' ||  invoice.invtype == 'Nil Supplies' || invoice.invtype == 'Credit/Debit Notes'|| invoice.invtype == 'Credit/Debit Note for Unregistered Taxpayers') {
								if(invoice.items){
									invoice.items.forEach(function(item) {
										if(item.hsn != '' && item.hsn != null){
										if(item.hsn.indexOf(':') > 0) {
	...
	$(".reportTable5  div.toolbar").html('<h4>Custom Summary of '+clientname+'</h4>');
...
<div class="breadcrumbwrap" >
	...
	<div class="row">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">HSN Sales Report</li>
		</ol>
	...
	<div class="db-ca-wrap monthely1">
		<div class="container">
			...
			<h5>Monthly HSN Sales Report of <c:choose><c:when test='${fn:length(client.businessname) > 25}'>${fn:substring(client.businessname, 0, 25)}..</c:when><c:otherwise>${client.businessname}</c:otherwise></c:choose></h5><p>Monthly HSN Sales Report gives you a summary of your monthly sales.</p>
			...
			<div class="dropdown-content reporthsnSales"> <span class="arrow-up"></span><span class="pl-2"> All the Sale Invoices from your SaleRegister/Books Monthly, Yearly and Custom Wise Based On HSN</span></div>
	...
	<div class="db-ca-wrap yearly1" style="display: none">
		<div class="container">
			<div class=" "></div>
			<a href="${contextPath}/dreports/${id}/${fullname}/${usertype}/${client.id}/${month}/${year}" class="btn btn-blue-dark pull-right" role="button" style="padding: 4px 25px;">Back</a>
			<h5>Yearly HSN Sales Report of <c:choose><c:when test='${fn:length(client.businessname) > 25}'>${fn:substring(client.businessname, 0, 25)}..</c:when><c:otherwise>${client.businessname}</c:otherwise></c:choose></h5><p>Yearly HSN Sales Report gives you a summary of your annual sales.</p>
	...
	<div class="db-ca-wrap custom1" style="display: none">
		<div class="container">
			<div class=" "></div>
			<a href="${contextPath}/dreports/${id}/${fullname}/${usertype}/${client.id}/${month}/${year}" class="btn btn-blue-dark pull-right" role="button" style="padding: 4px 25px;">Back</a>
			<h5>Custom HSN Sales Report of <c:choose><c:when test='${fn:length(client.businessname) > 25}'>${fn:substring(client.businessname, 0, 25)}..</c:when><c:otherwise>${client.businessname}</c:otherwise></c:choose></h5><p>Custom HSN Sales Report gives you a summary of your monthly, quarterly and annual sales.</p>
  ...
  <div class="modal-dialog modal-md modal-right" role="document">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <div class=" p-2 steptext-wrap"><span class="pl-2"> All the Sale Invoices from your SaleRegister/Books Monthly, Yearly and Custom Wise Based On HSN</span> </div>
      </div>
...
$(document).ready(function() {
	$( ".helpicon" ).hover(function() {$('.reporthsnSales ').show();
	}, function() {$('.reporthsnSales ').hide();
	});
		...
		var content='';
			if(invoiceList instanceof Array) {
				if(invoiceList.length > 0) {
					...
					var i=1;
					invoiceList.forEach(function(invoice){
					 if(invoice.invtype == 'B2B' || invoice.invtype == 'B2C' || invoice.invtype == 'Exports' || invoice.invtype == 'Advance Adjusted Detail' ||invoice.invtype == 'Advances' ||  invoice.invtype == 'Nil Supplies' || (invoice.invtype == 'Credit/Debit Notes' && invoice.cdnr[0].nt[0].ntty == 'D') || (invoice.invtype == 'Credit/Debit Note for Unregistered Taxpayers' && invoice.cdnur[0].ntty == 'D')) {
						if(invoice.items){
							invoice.items.forEach(function(item) {
