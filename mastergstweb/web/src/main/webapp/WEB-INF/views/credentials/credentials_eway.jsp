			...
			<div class="col-sm-12">
				<div class="navbar-left">
					<ul>
						...
						<li class="nav-item">
							<a class="nav-link urllink active" href="${contextPath}/credentials?id=<c:out value="${id}"/>&fullname=<c:out value="${fullname}"/>&usertype=<c:out value="${usertype}"/>&creType=eway" >e-Way Bill Credentials</a>
						</li>
						<li class="nav-item">
                        ...
                        <div class="credentialwrap">
                            <div class="row">
                                <div class="col-lg-3 col-md-2 col-sm-12 bdr-dashed-r">
                                  ...
                                  <h4 class="presize">Welcome to MasterGST e-Way Bill API Portal, please follow below steps to create sandbox access </h4>
                                  ...
                                  <p class="parafnt"><span class="welspn"><strong>Step1:</strong></span>Create MasterGST GST API Sandbox Credentials </p>
                                        <p class="parafnt"><span class="welspn"><strong>Step2:</strong></span>Use the MasterGST Registered Email, Client ID & Client Secret ID, GSTN User Name & GSTIN</p></div>
                                  
                                </div>
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <!--   profile table begin -->
                                    <div class="welhdr">
                                        <h5 class="welcomehr">Welcome to MasterGST e-Way Bill Credentials</h5>
                                    </div>
                                    <!-- Nav tabs -->
    ...
    <ul class="nav nav-tabs" role="tablist">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="credential" role="tabpanel">
            		<c:if test="${EwayBillSandBox == null }">
                    ...
                    <table id="dbTable" class="display row-border dataTable meterialform" cellspacing="0" width="100%">
                            ...
                            <tbody>
								<c:if test="${EwayBillSandBox != null }">
									...
									<c:if test="${EwayBillSandBox.isenabled}">
										<c:set var="isEnabled" value="Enabled"/>
									</c:if>		
				                    <tr>
				                      <td>${EwayBillSandBox.clientid}</td>
				                      <td>${EwayBillSandBox.clientsecret}</td>
				                      <td>${isEnabled}</td>
				                    </tr>
				                    </c:if>
                            </tbody>
            ...
            <c:if test="${EwayBillProduction == null }">
            ...
            <ol class="prokeylist">
             ...
             <c:if test="${EwayBillProduction != null }">
             <c:set var="isEwayProdEnabled" value="Disabled"/>
				<c:if test="${EwayBillProduction.isenabled}">
				<c:set var="isEwayProdEnabled" value="Enabled"/>
				</c:if>	
            <table id="dbTable-prod" class="display row-border dataTable meterialform" cellspacing="0" width="100%">
                            ...
                            <tbody>
			                    <tr>
			                      <td>${EwayBillProduction.clientid}</td>
			                      <td>${EwayBillProduction.clientsecret}</td>
			                      <td>${isEwayProdEnabled}</td>
			                    </tr>
                            </tbody>
                        </table>
            </c:if>
...
<!--                                 </div></div> -->
								<input type="hidden" name="stage" value="EwayBillSandBox"/>
