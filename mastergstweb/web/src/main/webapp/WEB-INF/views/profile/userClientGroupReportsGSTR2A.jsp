...
<div class="breadcrumbwrap">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">GST Group Wise GSTR2A Reports</li>
					</ol>
	...
	<div class="db-ca-wrap monthely1">
		<div class="container">
			...
			<h2>
				<span class="reports-monthly">Group wise Monthly GSTR2A Report</span>
				<span class="reports-yearly" style="display: none;">Group wise Yearly GSTR2A Report</span>
			</h2>
			<p>
				<span class="reports-monthly">Group wise Monthly GSTR2A Report gives you a summary of your monthly GSTR2A.<span id="monthly_clients_errormsg"></span></span>
				<span class="reports-yearly" style="display: none;">Group wise Yearly GSTR2A Report gives you a summary of your annual sales.<span id="yearly_clients_errormsg"></span></span>
			</p>
		...
		<div class="tab-pane" id="gtab1" role="tabpanel">
					...
					<div class="filter">
						<div class="noramltable-row">
							...
							<div class="noramltable-row-desc">
								<div class="sfilter">
									<span id="divFiltersGSTR2A"></span><span class="btn-remove-tag" onClick="clearFilters('GSTR2A','')">Clear All<span data-role="remove"></span></span>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="noramltable-row">
				...
				<div class="noramltable-row-desc">
					<div class="normaltable-col hdr">Total Invoices<div class="normaltable-col-txt" id="idCountGSTR2A"></div></div>
					<div class="normaltable-col hdr">Total Taxable Value<div class="normaltable-col-txt" id="idTaxableValGSTR2A"></div></div>
					<div class="normaltable-col hdr">Total Tax Value<div class="normaltable-col-txt" id="idTaxValGSTR2A"></div></div>
					<div class="normaltable-col hdr">Total Amount <div class="normaltable-col-txt" id="idTotAmtValGSTR2A"></div></div>
					<div class="normaltable-col hdr filsummary">Total IGST<div class="normaltable-col-txt" id="idIGSTGSTR2A"></div></div>
					<div class="normaltable-col hdr filsummary">Total CGST<div class="normaltable-col-txt" id="idCGSTGSTR2A"></div></div>
					<div class="normaltable-col hdr filsummary">Total SGST<div class="normaltable-col-txt" id="idSGSTGSTR2A"></div></div>
					<div class="normaltable-col hdr filsummary">Total CESS<div class="normaltable-col-txt" id="idCESSGSTR2A"></div></div>
					<div class="normaltable-col hdr">Total ITC<div class="normaltable-col-txt" id="idITCValGSTR2A"></div></div>
				</div>
		</div>
	</div>
	...
	<div class="customtable db-ca-view salestable reportsdbTableGSTR2A">
					<table id='gloablReports_dataTableGSTR2A' class="row-border dataTable meterialform" cellspacing="0" width="100%">
						<thead>
							<tr>
