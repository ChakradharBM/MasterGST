...
<head>
<title>MasterGST | Features</title>
...
<!--- breadcrumb end -->
                        ...
                        <table id="dbTable1" class="display row-border dataTable meterialform" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">${feature.featureid}</td>
                                    <td align="center">${feature.featurename}</td>
                                    <td class="actionicons"><a class="btn-edt" href="#" data-toggle="modal" data-target="#editModal${feature.id}"><i class="fa fa-edit"></i> </a></td>
                                </tr>
								</c:forEach>
                            </tbody>
                        </table>
  ...
  <!-- dashboard cp table end -->
        ...
        <div class="modal-dialog modal-md modal-right" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body meterialform bs-fancy-checks">
                    ...
                    <!-- row begin -->
					<form:form method="POST" data-toggle="validator" class="meterialform" name="featureform" action="${contextPath}/createfeature/${id}/${fullname}/${usertype}/${month}/${year}" modelAttribute="feature">
					<div class="row  p-5">
                        <div class="form-group col-md-6 col-sm-12">
                            <p class="lable-txt astrich">Feature Id</p>
                            <span class="errormsg" id="userName_Msg"></span>
                            <input type="text" id="featureid" name="featureid" required="required" data-error="Please enter more than 1 characters" placeholder="1001" value="" />
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            ...
                            <input type="text" id="featurename" name="featurename" required="required" placeholder="190" value="" />
    ...
    <!-- Add Modal End -->
		 <!-- Edit Modal Start -->
	<c:forEach items="${features}" var="feature">
    <div class="modal fade" id="editModal${feature.id}" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md modal-right" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body meterialform bs-fancy-checks">
                    ...
                    <div class="row  p-5">
                        <div class="form-group col-md-6 col-sm-12">
                            <p class="lable-txt astrich">Feature Id</p>
                            <span class="errormsg" id="userName_Msg"></span>
                            <input type="text" id="featureid" name="featureid" required="required"  placeholder="1001" value="${feature.featureid}" />
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            <p class="lable-txt astrich">Name</p>
                            <span class="errormsg" id="role_Msg"></span>
                            <input type="text" id="featurename" name="featurename" required="required" placeholder="190" value="${feature.featurename}" />
                            <label for="description" class="control-label"></label>
                            <i class="bar"></i> </div>
						...
						<div class="form-group col-md-12 col-sm-12">
							...
							<div class="form-group col-md-12 col-sm-12">
								...
								<c:forEach items="${permissionArray}" var="pName" varStatus="loop">
									...
									<c:forEach items="${feature.permissions[fName]}" var="permission">
                        ...
                        <div class="col-12 text-center mt-3" style="display:block">
							...
							<input type="hidden" name="createdDate" value='<fmt:formatDate pattern="yyyy-MM-dd" value="${feature.createdDate}" />'>
							<input type="hidden" name="createdBy" value="${feature.createdBy}">
    ...
    <script type="text/javascript">
        var table = $('table.display').DataTable({
		  ...
		  $("div.toolbar").html('<h4>Features</h4><a href="#" class="btn btn-blue-dark"  data-toggle="modal" data-target="#addModal">Add</a> ');
		...
		$(document).ready(function() {
			$('#cpPermissionNav').addClass('active');
        });
    </script>
	<c:choose>
	<c:when test='${not empty client && not empty client.id}'>
