...
<div class="breadcrumbwrap">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">GST Group Wise GSTR1 Reports</li>
					</ol>
	...
	<div class="db-ca-wrap monthely1">
		<div class="container">
			...
			<h2>
				<span class="reports-monthly">Group wise Monthly GSTR1 Report</span>
				<span class="reports-yearly" style="display: none;">Group wise Yearly GSTR1 Report</span>
				<span class="reports-custom" style="display: none;">Group wise Custom GSTR1 Report</span>
			</h2>
			<p>
				<span class="reports-monthly">Group wise Monthly GSTR1 Report gives you a summary of your monthly GSTR1.<span id="monthly_clients_errormsg"></span></span>
				<span class="reports-yearly" style="display: none;">Group wise Yearly GSTR1 Report gives you a summary of your monthly GSTR1.<span id="yearly_clients_errormsg"></span></span>
				<span class="reports-custom" style="display: none;">Group wise Custom GSTR1 Report gives you a summary of your monthly GSTR1.<span id="custom_clients_errormsg"></span></span>
			</p>
					...
					<div class="filter">
						<div class="noramltable-row">
							...
							<div class="noramltable-row-desc">
								<div class="sfilter">
									<span id="divFilters${varRetTypeCode}"></span><span class="btn-remove-tag" onClick="clearFilters('GSTR1','')">Clear All<span data-role="remove"></span></span>
								</div>
							</div>
						</div>
					</div>
	...
	<div class="customtable db-ca-view reportTable reportTable4 fixed-col-div" id="${varRetTypeCode}SummaryTable" style="display:none">
				<div class ="row">
				    ...
				    <div class="col-sm-3"><a href="#" id="groupwise_dwnldxls" class="btn btn-blue mb-3 pull-right excel_btn" style="padding: 6px 15px 5px;font-weight: bold;color: #435a93;" data-toggle="tooltip" data-placement="top" title="Download Financial Summary To Excel">Download To Excel<i class="fa fa-download ml-1" aria-hidden="true"></i></a></div>
				    </div>
