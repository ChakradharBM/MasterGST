...
<head>
<title>MasterGST | Group Wise GSTR2B Report</title>
...
<script src="${contextPath}/static/mastergst/js/reports/globalgstr2b_report.js" type="text/javascript"></script>
...
<div class="breadcrumbwrap">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">GST Group Wise GSTR2B Reports</li>
					</ol>
	...
	<div class="db-ca-wrap monthely1">
		<div class="container">
			...
			<h2>
				<span class="reports-monthly">Group wise Monthly GSTR2B Report</span>
				<span class="reports-yearly" style="display: none;">Group wise Yearly GSTR2B Report</span>
			</h2>
			<p>
				<span class="reports-monthly">Group wise Monthly GSTR2B Report gives you a summary of your monthly GSTR2B.<span id="monthly_clients_errormsg"></span></span>
				<span class="reports-yearly" style="display: none;">Group wise Yearly GSTR2B Report gives you a summary of your annual GSTR2B.<span id="yearly_clients_errormsg"></span></span>
			</p>
		...
		<div class="tab-pane" id="gtab1" role="tabpanel">
					...
					<div class="filter">
						<div class="noramltable-row">
							...
							<div class="noramltable-row-desc">
								<div class="sfilter">
									<span id="divFiltersGSTR2B"></span><span class="btn-remove-tag" onClick="clearFilters('GSTR2B','')">Clear All<span data-role="remove"></span></span>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="noramltable-row">
				...
				<div class="noramltable-row-desc">
					<div class="normaltable-col hdr">Total Invoices<div class="normaltable-col-txt" id="idCountGSTR2B"></div></div>
					<div class="normaltable-col hdr">Total Taxable Value<div class="normaltable-col-txt" id="idTaxableValGSTR2B"></div></div>
					<div class="normaltable-col hdr">Total Tax Value<div class="normaltable-col-txt" id="idTaxValGSTR2B"></div></div>
					<div class="normaltable-col hdr">Total Amount <div class="normaltable-col-txt" id="idTotAmtValGSTR2B"></div></div>
					<div class="normaltable-col hdr filsummary">Total IGST<div class="normaltable-col-txt" id="idIGSTGSTR2B"></div></div>
					<div class="normaltable-col hdr filsummary">Total CGST<div class="normaltable-col-txt" id="idCGSTGSTR2B"></div></div>
					<div class="normaltable-col hdr filsummary">Total SGST<div class="normaltable-col-txt" id="idSGSTGSTR2B"></div></div>
					<div class="normaltable-col hdr filsummary">Total CESS<div class="normaltable-col-txt" id="idCESSGSTR2B"></div></div>
					<div class="normaltable-col hdr">Total ITC<div class="normaltable-col-txt" id="idITCValGSTR2B"></div></div>
				</div>
		</div>
	</div>
	...
	<div class="customtable db-ca-view salestable reportsdbTableGSTR2B">
		<table id='gloablReports_dataTableGSTR2B' class="row-border dataTable meterialform" cellspacing="0" width="100%">
			<thead>
				<tr>
			...
			<tbody id='invBodyTableBody'></tbody>
		</table>
	</div>
</div>
</div>
	...
	$('#yearly_clients_errormsg').html('');
		...
		if(selectGroupArrayClientids.length == 0 || selectGroupArrayClientids[0] == 'GROUPS_NOTFOUND'){
			if(clientidsArray.length == 0 || clientidsArray[0]== 'CLIENTS_NOTFOUND'){
				...
				$('#yearly_clients_errormsg').html('');
				loadGlobalReportsUsersByClient('${id}', clientidsArray, '${varRetType}','${varRetTypeCode}', loadGlobalReportsUsersInDropDown);
				loadGlobalReportsInvoiceSupport(clientidsArray, '${varRetType}', '${varRetTypeCode}',0, year[0], abc,booksOrReturns, loadGlobalReportsCustomersInDropdown);
				loadGlobalReportsInvTable('${id}', clientidsArray, '${varRetType}','${varRetTypeCode}', 0, year[0], '${usertype}', '${fullname}', booksOrReturns, abc);
				loadGlobalReportsSummary('${id}', '${varRetTypeCode}',clientidsArray, 0, year[0],booksOrReturns, abc);
				initiateCallBacksForMultiSelectGlobalReports('${varRetType}','${varRetTypeCode}');
				initializeRemoveAppliedFiltersGlobalReports('${varRetType}','${varRetTypeCode}');
				invsDownloads('${id}', clientidsArray, '${varRetType}','${varRetTypeCode}', 0, year[0], '${usertype}', '${fullname}', booksOrReturns, 'Yearly');
			}
		}else{
			if(clientidsArray.length > 0 && clientidsArray[0] != 'CLIENTS_NOTFOUND'){
				$('#yearly_clients_errormsg').html('');
				...
				$('#yearly_clients_errormsg').html('');
				loadGlobalReportsUsersByClient('${id}', selectGroupArrayClientids, '${varRetType}','${varRetTypeCode}', loadGlobalReportsUsersInDropDown);
				loadGlobalReportsInvoiceSupport(selectGroupArrayClientids, '${varRetType}', '${varRetTypeCode}', 0, year[0], abc,booksOrReturns, loadGlobalReportsCustomersInDropdown);
				loadGlobalReportsInvTable('${id}', selectGroupArrayClientids, '${varRetType}','${varRetTypeCode}', 0, year[0], '${usertype}', '${fullname}', booksOrReturns, abc);
				loadGlobalReportsSummary('${id}','${varRetTypeCode}',selectGroupArrayClientids, 0, year[0],booksOrReturns, abc);
				initiateCallBacksForMultiSelectGlobalReports('${varRetType}','${varRetTypeCode}');
				initializeRemoveAppliedFiltersGlobalReports('${varRetType}','${varRetTypeCode}');
				invsDownloads('${id}', selectGroupArrayClientids, '${varRetType}','${varRetTypeCode}', 0, year[0], '${usertype}', '${fullname}', booksOrReturns, 'Yearly');
			}		
		}
	}
}
...
$(function(){
	...
	loadGlobalReportsUsersByClient('${id}', clientidsArray, '${varRetType}','${varRetTypeCode}', loadGlobalReportsUsersInDropDown);
	loadGlobalReportsInvoiceSupport(clientidsArray, '${varRetType}', '${varRetTypeCode}','${month}', '${year}', 'Monthly', 'dwnldfromgstn', loadGlobalReportsCustomersInDropdown);
