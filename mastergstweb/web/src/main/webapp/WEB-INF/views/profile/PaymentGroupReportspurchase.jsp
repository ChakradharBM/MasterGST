...
<div class="breadcrumbwrap">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">GST Group Wise Payments Made Report</li>
					</ol>
	...
	<div id="group_and_client" class="group_and_client" style="margin-top: 186px;">
		<div class="form-group" style="display:inline;">
			<select id="multeselectgroup_paymentsGSTR2" class="multeselectgroup multiselect-ui form-control" multiple="multiple">
			</select>
		</div>
		<div class="form-group" style="display:inline;">
			<select id="multeselectclient_paymentsGSTR2" class="multeselectclient multiselect-ui form-control" multiple="multiple">
			</select>
		</div>
	</div>
	<div class="db-ca-wrap monthely1" id="monthely_payments">
		<div class="container">
			...
			<h4>Group wise Monthly Payments Made Report of&nbsp;<c:out value="${user.fullname}"/><c:choose><c:when test='${fn:length(client.fullname) > 25}'>${fn:substring(client.fullname, 0, 25)}..</c:when><c:otherwise>${client.fullname}</c:otherwise></c:choose> </h4><p>Monthly Payment Report gives you a summary of your monthly Payments.<span id="monthly_clients_errormsg"></span></p>
	...
	<div class="noramltable-row">
		...
		<div class="noramltable-row">
			...
			<div class="normaltable-col hdr" style="width:235px;">Total Payments<div class="normaltable-col-txt" id="idCountGSTR2"></div></div>
			 <!-- <div class="normaltable-col hdr">Total Amount<div class="normaltable-col-txt" id="idTotalAmtGSTR2"></div></div> -->
				<div class="normaltable-col hdr" style="width:235px;">Total Amount Paid<div class="normaltable-col-txt" id="idTotalValGSTR2"></div></div>
				<!-- <div class="normaltable-col hdr">Pending Amount<div class="normaltable-col-txt" id="idPendAmtGSTR2"></div></div> -->
				</div>
	</div>
	</div>
			</div>
			<div id="monthProcess" class="text-center" style="display:none;"></div>
			<div class="customtable db-ca-view globalpurchasetable1">
		<table id='globalpurchasetable1' class="row-border dataTable meterialform" cellspacing="0" width="100%">
			<thead><tr><th class="text-center" width=5%>S.no</th><th class="text-center" width=12%>Date</th><th class="text-center">Payment Id</th><th class="text-center">Invoice Number</th><th class="text-center">Supplier</th><th class="text-center">GSTIN</th><th class="text-center">Total Amount Paid</th><th class="text-center">Payment Mode</th><th class="text-center">Reference No</th><th class="text-center" style="display:none;">Financial Year</th></tr></thead>			<tbody id='invBodysalestable1'>
			</tbody>
		</table>
	</div>
		</div>
...
<div class="noramltable-row">
		...
		<div class="noramltable-row-hdr">Filter Summary</div>
		<div class="noramltable-row-desc">
				<div class="normaltable-col hdr" style="width:235px;">Total Payments<div class="normaltable-col-txt" id="idCountyearGSTR2"></div></div>
				<!-- <div class="normaltable-col hdr">Total Amount<div class="normaltable-col-txt" id="idTotalAmtyearGSTR2"></div></div> -->
				<div class="normaltable-col hdr" style="width:235px;">Total Amount Paid<div class="normaltable-col-txt" id="idTotalValyearGSTR2"></div></div>
				<!-- <div class="normaltable-col hdr">Pending Amount<div class="normaltable-col-txt" id="idPendAmtyearGSTR2"></div></div> -->
				</div>
				</div>
	</div>
			</div>
			<div id="yearProcess" class="text-center" style="display:none;"></div>
			<div class="customtable db-ca-view globalpaymentpurchasetable2" >
				<table id="globalpaymentpurchasetable2" class="display row-border dataTable meterialform" cellspacing="0" width="100%">
					<thead><tr><th class="text-center" width=5%>S.no</th><th class="text-center" width=12%>Date</th><th class="text-center">Payment Id</th><th class="text-center">Invoice Number</th><th class="text-center">Supplier</th><th class="text-center">GSTIN</th><th class="text-center">Total Amount Paid</th><th class="text-center">Payment Mode</th><th class="text-center">Reference No</th><th class="text-center" style="display:none;">Financial Year</th><th class="text-center" style="display:none;">Month</th></tr></thead>
...
<div class="noramltable-row"><div class="noramltable-row-hdr">Search Filter</div>
			<div class="noramltable-row-desc">	<select id="multiselectcustomGSTR11" class="multiselect-ui form-control" multiple="multiple"><option value="2021">2021-2022</option><option value="2020">2020-2021</option><option value="2019">2019-2020</option><option value="2018">2018-2019</option><option value="2017">2017-2018</option></select>
				<select id="multiselectGSTR15" class="multiselect-ui form-control" multiple="multiple"><option value="01">January</option><option value="02">February</option><option value="03">March</option><option value="04">April</option><option value="05">May</option><option value="06">June</option><option value="07">July</option><option value="08">August</option><option value="09">September</option><option value="10">October</option><option value="11">November</option><option value="12">December</option></select>
		...
		<div class="noramltable-row-hdr">Filter Summary</div>
		<div class="noramltable-row-desc">
				<div class="normaltable-col hdr" style="width:235px;">Total Payments<div class="normaltable-col-txt" id="idCountcustomGSTR2"></div></div>
				 <!-- <div class="normaltable-col hdr">Total Amount<div class="normaltable-col-txt" id="idTotalAmtcustomGSTR2"></div></div> -->
				<div class="normaltable-col hdr" style="width:235px;">Total Amount To Be Paid<div class="normaltable-col-txt" id="idTotalValcustomGSTR2"></div></div>
				<!-- <div class="normaltable-col hdr">Pending Amount<div class="normaltable-col-txt" id="idPendAmtcustomGSTR2"></div></div> -->
				</div>
				</div>
	</div>
			</div>
			...
			<div class="customtable db-ca-view globalpaymentpurchasetable3">
		<table id='globalpaymentpurchasetable3' class="row-border dataTable meterialform" cellspacing="0" width="100%">
			<thead><tr><th class="text-center" width=5%>S.no</th><th class="text-center" width=12%>Date</th><th class="text-center">Payment Id</th><th class="text-center">Invoice Number</th><th class="text-center">Supplier</th><th class="text-center">GSTIN</th><th class="text-center">Total Amount Paid</th><th class="text-center">Payment Mode</th><th class="text-center">Reference No</th><th class="text-center" style="display:none;">Financial Year</th><th class="text-center" style="display:none;">Month</th></tr></thead>
...
var groupPaymentsPurchaseTable;
var salesFileName;var gstnnumber='<c:out value="${client.gstnnumber}"/>';

	<c:forEach items="${listOfClients}" var="clients">
	$("#multeselectclient_paymentsGSTR2").append($("<option></option>").attr("value","${clients.id}").html("${clients.businessname}- <span> ${clients.gstnnumber}</span>"));
</c:forEach>
var counts=0;var groupArray=[], selectGroupArray=[];
<c:forEach items="${listOfClients}" var="group">
	<c:if test="${not empty group.groupName}">
		if(counts == 0){groupArray.push('<c:out value="${group.groupName}"/>');	$("#multeselectgroup_paymentsGSTR2").append($("<option></option>").attr("value","${group.groupName}").text("${group.groupName}"));}
		if(jQuery.inArray('<c:out value="${group.groupName}"/>', groupArray ) == -1){groupArray.push('<c:out value="${group.groupName}"/>');$("#multeselectgroup_paymentsGSTR2").append($("<option></option>").attr("value","${group.groupName}").text("${group.groupName}"));}
		counts++;
	</c:if>
</c:forEach>
	...
	$('#multeselectclient_paymentsGSTR2').multiselect({
	...
	$('#multeselectgroup_paymentsGSTR2').multiselect({
		...
		if(groupsnamelist == "GROUPS_NOTFOUND"){
    		...
    		$.ajax({
    			...
    			success : function(data) {
    				$('#multeselectclient_paymentsGSTR2').empty().multiselect('rebuild');
	    			for(var i =0;i <=data.length-1;i++){
	    				$("#multeselectclient_paymentsGSTR2").append($("<option></option>").attr("value",data[i].firstname).text(data[i].businessname+"-"+data[i].gstnnumber));
	    			} 
	    			$('#multeselectclient_paymentsGSTR2').multiselect('rebuild');
	    		},error : function(data) {}
    		});
    	}else{
    		$.ajax({
    ...
    function applyGroup() {
		var groupArr =new Array(); 
		var groupOptions = $('#multeselectgroup_paymentsGSTR2 option:selected');
	...
	function applyClient() {
	    ...
	    var clientOptions = $('#multeselectclient_paymentsGSTR2 option:selected');
	...
	function applyFilters(retType,val) {
		groupPaymentsPurchaseTable.clear();
		...
		groupPaymentsPurchaseTable.draw();
	}
});
	function commonInvoiceFilter(retType, arrFinancial, arrMonth, arrCustomer, arrGstin, arrPayment,vals) {
		if(groupPaymentsArray['GSTR1'].length > 0) {
			...
			if((arrFinancial.length == 0 || $.inArray('All', arrFinancial) >= 0 || $.inArray(row[9], arrFinancial) >= 0)
					...
					rowNode = groupPaymentsPurchaseTable.row.add(row);
					tpayments++;
			...
			if(vals=="month"){
				...
				$('#idCountGSTR2').html(tpayments);$('#idTotalValGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(tamt).toFixed(2)));$('#idTotalAmtGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(tamt+pbal).toFixed(2))); $('#idPendAmtGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(pbal).toFixed(2))); 
				}else if(vals=='year'){$('#idCountyearGSTR2').html(tpayments);$('#idTotalValyearGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(tamt).toFixed(2)));$('#idTotalamtyearGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(tamt+pbal).toFixed(2))); $('#idPendAmtyearGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(pbal).toFixed(2)));
				}else{$('#idCountcustomGSTR2').html(tpayments);$('#idTotalValcustomGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(tamt).toFixed(2)));$('#idTotalAmtcustomGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(tamt+pbal).toFixed(2))); $('#idPendAmtcustomGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(pbal).toFixed(2))); }
		}
	}
...
groupPaymentsPurchaseTable = $("#globalpurchasetable1, #globalpaymentpurchasetable2, #globalpaymentpurchasetable3").DataTable({
...
function ajaxFunctionCustom(clientidsArray,fromtime,totime){
	if ( $.fn.DataTable.isDataTable('#globalpaymentpurchasetable3') ) {$('#globalpaymentpurchasetable3').DataTable().destroy();}
	$('#globalpaymentpurchasetable3 tbody').empty();
	$.ajax({
		url: "${contextPath}/getselectedclientpaymentscustom/GSTR2/"+clientidsArray+"/"+fromtime+"/"+totime,
		async: true,
		cache: false,
		dataType:"json",
		contentType: 'application/json',
		...
		success : function(response){
			if(response.length > 0){
				...
				$('#globalpaymentpurchasetable3 tbody').html('');
					...
					$('#idCountcustomGSTR2').html(transcounts);
					$('#idTotalValcustomGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(totalamt).toFixed(2)));
					$('#idPendAmtcustomGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(pendamt).toFixed(2)));
					$('#idTotalAmtcustomGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(totFullAmt).toFixed(2)));
					$("#multiselectcustomGSTR12").multiselect('rebuild');
					$("#multiselectcustomGSTR13").multiselect('rebuild');
					groupPaymentsPurchaseTable = $("#globalpaymentpurchasetable3").DataTable({
						"dom": '<"toolbar"f>lrtip<"clear">', 		
						"paging": true,
						"searching": true,
						"lengthMenu": [ [10, 25, 50, -1], [10, 25, 50, "All"] ],
					...
					$(".globalpaymentpurchasetable3 div.toolbar").append('<a href="${contextPath}/dwnldxlscustomGroupPaymentsReceived/GSTR2/'+clientidsArray+'/'+fromtime+'/'+totime+'" id="monthlydwnldxls" class="btn btn-blue">Excel<i class="fa fa-download" aria-hidden="true" style="margin-left: 6px;"></i></a>');
					groupPaymentsArray['GSTR1'] = response;
					$('#customProcess').text('');
			}else{if ( $.fn.DataTable.isDataTable('#globalpaymentpurchasetable3') ) {$('#globalpaymentpurchasetable3').DataTable().destroy();}
			$('#globalpaymentpurchasetable3 tbody').empty();
			groupPaymentsPurchaseTable = $("#globalpaymentpurchasetable3").DataTable({
					"dom": '<"toolbar"f>lrtip<"clear">', 		
					"paging": true,
			...
			$(".globalpaymentpurchasetable3 div.toolbar").append('<a href="${contextPath}/dwnldxlscustomGroupPaymentsReceived/GSTR2/'+clientidsArray+'/'+fromtime+'/'+totime+'" id="monthlydwnldxls" class="btn btn-blue">Excel<i class="fa fa-download" aria-hidden="true" style="margin-left: 6px;"></i></a>');
			$('#idCountcustomGSTR2').html(0);
			$('#idTotalValcustomGSTR2').html(formatNumber(parseFloat(0).toFixed(2)));
			$('#idTotalAmtcustomGSTR2').html(formatNumber(parseFloat(0).toFixed(2)));
			$('#idPendAmtcustomGSTR2').html(formatNumber(parseFloat(0).toFixed(2)));
				$("#multiselectcustomGSTR12").multiselect('rebuild');
				$("#multiselectcustomGSTR13").multiselect('rebuild');$('#customProcess').text('');
			}
				},error:function(err){
				}
	});
...
function ajaxFunctionMonthly(clientidsArray,month,year){
	if ( $.fn.DataTable.isDataTable('#globalpurchasetable1') ) {$('#globalpurchasetable1').DataTable().destroy();}
	$('#globalpurchasetable1 tbody').empty();
	$.ajax({
		url: "${contextPath}/getselectedclientpaymentsmonthly/GSTR2/"+clientidsArray+"/"+month+"/"+year,
		async: true,
		cache: false,
		dataType:"json",
		contentType: 'application/json',
		...
		success : function(response){
			if(response.length > 0){
				var i=1;var custnames = [];var gstins = [];var counts=0;var totalamt = 0; var transcounts=0;var invnos={};var pendamt=0;var totFullAmt=0;
				$('#globalpurchasetable1 tbody').html('');
					$.each(response, function(index, itemData) {
						var date = itemData.paymentDate;
						var dt = date.split("-");
						itemData.financialYear = dt[2];
						...
						if(itemData.paymentitems != null && itemData.paymentitems.length > 0){
							$.each(itemData.paymentitems, function(index, payemntItemData) {
								$('#globalpurchasetable1 tbody').append('<tr><td class="text-center">'+i+'</td><td class="text-center">'+itemData.paymentDate+'</td><td class="text-center">'+itemData.voucherNumber+'</td><td class="text-center" class="text-center">'+itemData.invoiceNumber+'</td><td class="text-center">'+itemData.customerName+'</td><td class="text-center">'+itemData.gstNumber+'</td><td class="text-right">'+formatNumber(parseFloat(payemntItemData.amount).toFixed(2))+'</td><td class="text-center">'+payemntItemData.modeOfPayment+'</td><td class="text-center">'+payemntItemData.referenceNumber+'</td><td class="text-center" style="display:none;">'+itemData.financialYear+'</td><td class="text-center" style="display:none;">'+itemData.month+'</td></tr>');
								totalamt += parseFloat(payemntItemData.amount);
								totFullAmt += parseFloat(payemntItemData.previousPendingBalance);
								pendamt += parseFloat(payemntItemData.pendingBalance);
								counts++;
					...
					$('#idPendAmtGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(pendamt).toFixed(2)));
					$('#idTotalAmtGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(totFullAmt).toFixed(2)));
					$("#multiselectGSTR12").multiselect('rebuild');
					$("#multiselectGSTR13").multiselect('rebuild');
					
					groupPaymentsPurchaseTable = $("#globalpurchasetable1").DataTable({
						"dom": '<"toolbar"f>lrtip<"clear">', 		
						"paging": true,
						"searching": true,
						"lengthMenu": [ [10, 25, 50, -1], [10, 25, 50, "All"] ],
					...
					$(".globalpurchasetable1 div.toolbar").append('<a href="${contextPath}/dwnldxlsmonthlyGroupPaymentsReceived/GSTR2/'+clientidsArray+'/${month}/${year}" id="monthlydwnldxls" class="btn btn-blue">Excel<i class="fa fa-download" aria-hidden="true" style="margin-left: 6px;"></i></a>');
					groupPaymentsArray['GSTR1'] = response;
					$('#monthProcess').hide().text('');
			}else{if ( $.fn.DataTable.isDataTable('#globalpurchasetable1') ) {$('#globalpurchasetable1').DataTable().destroy();}
			$('#globalpurchasetable1 tbody').empty();
			groupPaymentsPurchaseTable = $("#globalpurchasetable1").DataTable({
					"dom": '<"toolbar"f>lrtip<"clear">', 		
					"paging": true,
...
function ajaxFunctionYearly(clientidsArray,years){
	if ( $.fn.DataTable.isDataTable('#globalpaymentpurchasetable2') ) {$('#globalpaymentpurchasetable2').DataTable().destroy();}
	$('#globalpaymentpurchasetable2 tbody').empty();
	$.ajax({
		url: "${contextPath}/getselectedclientpaymentsyearly/GSTR2/"+clientidsArray+"/"+years,
		async: true,
		cache: false,
		dataType:"json",
		contentType: 'application/json',
		...
		success : function(response){
			if(response.length > 0){
				var i=1;var custnames = [];var gstins = [];var counts=0;var totalamt = 0; var transcounts=0;var invnos={};var pendamt=0;var totFullAmt=0;
				$('#globalpaymentpurchasetable2 tbody').html('');
					$.each(response, function(index, itemData) {
						var date = itemData.paymentDate;
						var dt = date.split("-");
						itemData.financialYear = dt[2];
						...
						if(itemData.paymentitems != null && itemData.paymentitems.length > 0){
							$.each(itemData.paymentitems, function(index, payemntItemData) {
								$('#globalpaymentpurchasetable2 tbody').append('<tr><td class="text-center">'+i+'</td><td class="text-center">'+itemData.paymentDate+'</td><td class="text-center">'+itemData.voucherNumber+'</td><td class="text-center" class="text-center">'+itemData.invoiceNumber+'</td><td class="text-center">'+itemData.customerName+'</td><td class="text-center">'+itemData.gstNumber+'</td><td class="text-right">'+formatNumber(parseFloat(payemntItemData.amount).toFixed(2))+'</td><td class="text-center">'+payemntItemData.modeOfPayment+'</td><td class="text-center">'+payemntItemData.referenceNumber+'</td><td class="text-center" style="display:none;">'+itemData.financialYear+'</td><td class="text-center" style="display:none;">'+itemData.month+'</td></tr>');
								totalamt += parseFloat(payemntItemData.amount);
								totFullAmt += parseFloat(payemntItemData.previousPendingBalance);
								pendamt += parseFloat(payemntItemData.pendingBalance);
								counts++;
					...
					totFullAmt = totalamt + pendamt;
					$('#idCountyearGSTR2').html(transcounts);
					$('#idTotalValyearGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(totalamt).toFixed(2)));
					$('#idPendAmtyearGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(pendamt).toFixed(2)));
					$('#idTotalAmtyearGSTR2').html('<i class="fa fa-rupee"></i>'+formatNumber(parseFloat(totFullAmt).toFixed(2)));
					$("#multiselectyearGSTR12").multiselect('rebuild');
					$("#multiselectyearGSTR13").multiselect('rebuild');
					groupPaymentsPurchaseTable = $("#globalpaymentpurchasetable2").DataTable({
						"dom": '<"toolbar"f>lrtip<"clear">', 		
						"paging": true,
						"searching": true,
						"lengthMenu": [ [10, 25, 50, -1], [10, 25, 50, "All"] ],
					...
					$(".globalpaymentpurchasetable2 div.toolbar").append('<a href="${contextPath}/dwnldxlsyearlyGroupPaymentsReceived/GSTR2/'+clientidsArray+'/'+years+'" id="monthlydwnldxls" class="btn btn-blue">Excel<i class="fa fa-download" aria-hidden="true" style="margin-left: 6px;"></i></a>');
					groupPaymentsArray['GSTR1'] = response;
					$('#yearProcess').hide().text('');
			}else{if ( $.fn.DataTable.isDataTable('#globalpaymentpurchasetable2') ) {$('#globalpaymentpurchasetable2').DataTable().destroy();}
			$('#globalpaymentpurchasetable2 tbody').empty();
			groupPaymentsPurchaseTable = $("#globalpaymentpurchasetable2").DataTable({
					"dom": '<"toolbar"f>lrtip<"clear">', 		
					"paging": true,
			...
			$(".globalpaymentpurchasetable2 div.toolbar").append('<a href="${contextPath}/dwnldxlsyearlyGroupPaymentsReceived/GSTR2/'+clientidsArray+'/'+years+'" id="monthlydwnldxls" class="btn btn-blue">Excel<i class="fa fa-download" aria-hidden="true" style="margin-left: 6px;"></i></a>');
			$('#idCountyearGSTR2').html(0);
			$('#idTotalValyearGSTR2').html(formatNumber(parseFloat(0).toFixed(2)));
			$('#idTotalAmtyearGSTR2').html(formatNumber(parseFloat(0).toFixed(2)));
			$('#idPendAmtyearGSTR2').html(formatNumber(parseFloat(0).toFixed(2)));
				$("#multiselectGSTR12").multiselect('rebuild');
