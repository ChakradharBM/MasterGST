          ...
          <form class="meterialform invoiceform" style="min-height: 725px;height: auto;">
            ...
            <div class="row mb-0">
             ...
             <c:if test="${empty client.logoid}"> <img src="${contextPath}/static/mastergst/images/master/defaultcompany.png" alt="Logo" class="imgsize col-md-12" style="width:150px;float:right;position:relative;"></c:if>
              <h2 class="text-right col-md-12 mt-3" style="float:right;">${invText} </h2>
              </div>
              </div>
            </div>
                  ...
                  <c:set var="aAmt" value="${item.rateperitem}" />
                    <tr>
                      ...
                      <td style="font-size:12px;" align="center"><c:choose><c:when test="${fn:contains(item.hsn, ' :')}">${fn:substring(item.hsn, 0, fn:indexOf(item.hsn, " :"))}</c:when><c:otherwise>${item.hsn}</c:otherwise></c:choose></td>
                       <%-- <td align="center" style="font-size:12px;">${item.uqc}</td> 
                       <td align="center" style="font-size:12px;">${item.barCode}</td>--%>
                       <td align="center" style="font-size:12px;">${item.quantity}</td>
                     
                      <td class="textright" style="font-size:12px;"><span class="indformat">${item.rateperitem}</span></td>
                      <td class="textright" style="font-size:12px;"><span class="indformat">${item.discount}</span></td>
