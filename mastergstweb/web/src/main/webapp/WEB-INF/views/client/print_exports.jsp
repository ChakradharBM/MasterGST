            ...
            <div class="invoice-hdr userdetails">
			  ...
			  <div class="ml-2"><h3><c:choose><c:when test="${returntype eq 'GSTR1' || returntype eq 'DELIVERYCHALLANS' || returntype eq 'PROFORMAINVOICES' || returntype eq 'ESTIMATES'}">${client.businessname}</c:when><c:otherwise>${invoice.billedtoname}</c:otherwise></c:choose></h3></div>
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                  <tr>
                    ...
                    <td width="40%" style="vertical-align:top"><table width="100%" border="0" cellspacing="0" cellpadding="5">
						...
						<tr><td style="text-align: right;"><strong>Place Of Supply</td><td> :</td> </strong><td style="text-align: right;">${invoice.statename}</td>
						</tr>
						<tr><td style="text-align: right;"><strong>State Code </td><td>:</td> </strong><td style="text-align: right;">${istate_code}</td></tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td <c:if test="${not empty invoice.consigneeaddress}">width="47%"</c:if> <c:if test="${empty invoice.consigneeaddress}">width="50%"</c:if> class="comp-addres"><h3><strong>Details Of Receiver(Billed To) </strong></h3>
              ...
              <div class="customtable invoicetable">
				  ...
				  <c:set var="aAmt" value="${item.rateperitem}" />
                   ...
                   <tfoot>
                     <tr>
					  ...
					  <th colspan="3" class="text-right whit_bg">&nbsp;</th>
                ...
                <table id="invoicetable1" class="display dataTable meterialform" cellspacing="0" width="100%" style="font-size:12px;">
				  ...
				  <tr>
                    ...
                    <td><div align="right" style="font-size: 12px!important;">${currencyTotal}</div></td>
                  </tr>
				  </c:if>
