          ...
          <form class="meterialform invoiceform" style="min-height: 725px;height: auto;">
            <div class="invoice-hdr userdetails">
              <table width="100%" border="0" cellspacing="0" cellpadding="5">
                <tr>
                  <td width="50%" class="imgsize-wrap"></td>
                  <td width="50%"></td>
                </tr>
              </table>
            </div>
            ...
            <div class="invoice-hdr userdetails">
              <div class="row m-0">
			  <div class="ml-2" style="text-align: center;"><h3><c:choose><c:when test="${returntype eq 'GSTR1' || returntype eq 'DELIVERYCHALLANS' || returntype eq 'PROFORMAINVOICES' || returntype eq 'ESTIMATES'}">TAX INVOICE</c:when><c:otherwise>${invoice.billedtoname}</c:otherwise></c:choose></h3></div>
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                  <tr>
                    ...
                    <td width="40%" style="vertical-align:top"><table width="100%" border="0" cellspacing="0" cellpadding="5">
						...
						<tr>
                          <td><div class="lable-txt text-right">Reference.No</div></td>
                          <td>:</td>
                          <td style="text-align: right;"><span class="f-14"><strong>${invoice.referenceNumber}</strong></span></td>
                        </tr>
                        <tr>
