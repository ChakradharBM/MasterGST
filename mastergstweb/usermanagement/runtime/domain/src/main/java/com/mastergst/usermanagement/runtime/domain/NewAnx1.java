...
public class NewAnx1 extends AnxInvoiceParent {
	...
	public List<AnxDetails> getRev() {
		return rev;
	}

	public void setRev(List<AnxDetails> rev) {
		this.rev = rev;
	}
