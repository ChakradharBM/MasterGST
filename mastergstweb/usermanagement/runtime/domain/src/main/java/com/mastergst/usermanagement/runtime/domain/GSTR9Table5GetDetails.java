...
public class GSTR9Table5GetDetails {
	...
	GSTR9Table5ItemDetails subTotalAF = new GSTR9Table5ItemDetails();
	@JsonProperty("sub_totalHK")
	GSTR9Table5ItemDetails subTotalHK = new GSTR9Table5ItemDetails();
	@JsonProperty("tover_tax_np")
	GSTR9Table5ItemDetails toverTaxNp = new GSTR9Table5ItemDetails();
	@JsonProperty("total_tover")
	GSTR9Table4OtherThanExpSezDetails totalTover = new GSTR9Table4OtherThanExpSezDetails();
	
	
	public GSTR9Table5GetDetails() {
	...
	public GSTR9Table5ItemDetails getSubTotalAF() {
		return subTotalAF;
	}

	public void setSubTotalAF(GSTR9Table5ItemDetails subTotalAF) {
		this.subTotalAF = subTotalAF;
	}

	public GSTR9Table5ItemDetails getSubTotalHK() {
		return subTotalHK;
	}

	public void setSubTotalHK(GSTR9Table5ItemDetails subTotalHK) {
		this.subTotalHK = subTotalHK;
	}

	public GSTR9Table5ItemDetails getToverTaxNp() {
		return toverTaxNp;
	}

	public void setToverTaxNp(GSTR9Table5ItemDetails toverTaxNp) {
		this.toverTaxNp = toverTaxNp;
	}

	public GSTR9Table4OtherThanExpSezDetails getTotalTover() {
		return totalTover;
	}

	public void setTotalTover(GSTR9Table4OtherThanExpSezDetails totalTover) {
		this.totalTover = totalTover;
	}
