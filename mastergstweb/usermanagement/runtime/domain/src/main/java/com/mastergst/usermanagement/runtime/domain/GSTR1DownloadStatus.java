...
@Document(collection = "GSTR1DownloadStatus")
public class GSTR1DownloadStatus extends Base {
	...
	public String toString() {
		return "GSTR1DownloadStatus [userid=" + userid + ", clientid=" + clientid + ", returnperiod=" + returnperiod
