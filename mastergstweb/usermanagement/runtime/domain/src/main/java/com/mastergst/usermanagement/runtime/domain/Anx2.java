...
@JsonIgnoreProperties({"id", "userid", "fullname", "clientid", "createdDate", "createdBy", "updatedDate", "updatedBy", 
	...
	"qrtCd","yrCd","trDatemthCd","trDateqrtCd","trDateyrCd","sftr","totaltaxableamount_str","totaltax_str","totalamount_str","dateofinvoice_str","ewayBillDate_str","eCommSupplyType","addressType","buyerPincode","einvCategory","einvExpCategory","countryCode","irnNo","irnStatus","taxSch","version","typ","totalStateCessAmount","totalAssAmount","totalCessNonAdVal",
	"dispatcherDtls","shipmentDtls","docDtls","tranDtls","sellerDtls","buyerDtls","valDtls","bchDtls","payDtls","refDtls","addlDocDtls","expDtls","ewbDtls","itemList",
	"DispatcherDtls","ShipmentDtls","DocDtls","TranDtls","SellerDtls","BuyerDtls","ValDtls","BchDtls","PayDtls","RefDtls","AddlDocDtls","ExpDtls","EwbDtls","ItemList","fp"})
public class Anx2 extends InvoiceParent {
