...
public class Anx1InvoiceSupport extends Base {
	...
	List<GSTRB2CL> b2cl=LazyList.decorate(new ArrayList<GSTRB2CL>(), 
			FactoryUtils.instantiateFactory(GSTRB2CL.class));
	List<GSTRB2CS> b2cs=LazyList.decorate(new ArrayList<GSTRB2CS>(), 
			FactoryUtils.instantiateFactory(GSTRB2CS.class));
	...
	public AddlDocDetails getAddlDocDtls() {
		return addlDocDtls;
	}
	public void setAddlDocDtls(AddlDocDetails addlDocDtls) {
