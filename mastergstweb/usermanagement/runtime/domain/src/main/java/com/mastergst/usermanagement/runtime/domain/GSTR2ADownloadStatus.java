...
@Document(collection = "GSTR2ADownloadStatus")
public class GSTR2ADownloadStatus extends Base {
	...
	public String toString() {
		return "GSTR2ADownloadStatus [userid=" + userid + ", clientid=" + clientid + ", returnperiod=" + returnperiod
