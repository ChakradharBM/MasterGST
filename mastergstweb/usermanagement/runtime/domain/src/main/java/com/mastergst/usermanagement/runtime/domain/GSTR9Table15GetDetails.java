...
public class GSTR9Table15GetDetails {
	...
	GSTR9Table15DemandtaxSummaryDetails dmndPend = new GSTR9Table15DemandtaxSummaryDetails();
	
	public GSTR9Table15GetDetails() {
	...
	public GSTR9Table15DemandtaxSummaryDetails getDmndPend() {
		return dmndPend;
	}

	public void setDmndPend(GSTR9Table15DemandtaxSummaryDetails dmndPend) {
