...
public class GSTRCreditDebitNotes {
	...
	private List<GSTRInvoiceDetails> nt=LazyList.decorate(new ArrayList<GSTRInvoiceDetails>(), 
			FactoryUtils.instantiateFactory(GSTRInvoiceDetails.class));
	
	public GSTRCreditDebitNotes() {
	...
	public List<GSTRInvoiceDetails> getNt() {
		return nt;
	}

	public void setNt(List<GSTRInvoiceDetails> nt) {
		this.nt = nt;
	}
