...
public class ANX2ResponseData {
	...
	private AnxInvoiceSupport errorReport;
	...
	public ANX2ResponseData() {

	}

	public ANX2ResponseData(String referenceId, String statusCd, AnxInvoiceSupport errorReport) {
	...
	public AnxInvoiceSupport getErrorReport() {
		return errorReport;
	}

	public void setErrorReport(AnxInvoiceSupport errorReport) {
		this.errorReport = errorReport;
	}
