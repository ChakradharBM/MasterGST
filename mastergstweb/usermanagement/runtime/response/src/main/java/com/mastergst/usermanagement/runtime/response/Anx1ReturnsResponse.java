...
public class Anx1ReturnsResponse {
	...
	@JsonProperty("data")
	private Anx1InvoiceSupport data;

	public Anx1ReturnsResponse() {

	}

	public Anx1ReturnsResponse(String statuscd, String statusdesc) {
		this.statuscd = statuscd;
		this.statusdesc = statusdesc;
	}

	public Anx1ReturnsResponse(String statuscd, Error error) {
		this.statuscd = statuscd;
		this.error = error;
	}
	...
	public Anx1InvoiceSupport getData() {
		return data;
	}

	public void setData(Anx1InvoiceSupport data) {
		this.data = data;
	}
