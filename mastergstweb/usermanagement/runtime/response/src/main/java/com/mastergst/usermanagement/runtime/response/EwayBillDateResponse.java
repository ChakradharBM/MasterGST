...
public class EwayBillDateResponse {
	...
	public EwayBillDateResponse() {

	}

	public EwayBillDateResponse(String statuscd, String statusdesc) {
		this.statuscd = statuscd;
		this.statusdesc = statusdesc;
	}

	public EwayBillDateResponse(String statuscd, Error error) {
		this.statuscd = statuscd;
		this.error = error;
	}
